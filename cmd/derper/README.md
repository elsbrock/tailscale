...
* You must build and update the `cmd/derper` binary yourself. There are no
  ...
  version of Go. You should update this binary approximately as regularly as you update Tailscale nodes.
...
* Go pprof can be accessed via the debug port `8383`

* Prometheus compatible metrics can be gathered from the debug port `8383`
